...
func (u *UpdateCommandRunner) Run(ctx context.Context, cmd *cli.Command) error {
	basePath := cmd.StringArg("target")

	config, err := models.LoadConfigTomlFromFile(basePath)
	if err != nil {
		return err
	}
	...
	if err := u.SaveComposeFile(compose, basePath); err != nil {
		return err
	}
...
func (u *UpdateCommandRunner) SaveComposeFile(compose *types.Project, basePath string) error {
...
var _ interfaces.CommandRunner = (*UpdateCommandRunner)(nil)
